...
import pathes
# import data_iceland
# from networks.hiv import data_dolphins
from networks.dolphins import data_dolphins

# A = networks.hiv.data_dolphins.A
#
# N = networks.hiv.data_dolphins.N  # number of nodes
#
# E = networks.hiv.data_dolphins.E  # number of edges
#
# Cn = networks.hiv.data_dolphins.Cn    # cost of each vaccine
#
# gamma = networks.hiv.data_dolphins.gamma  # curing rate

A = data_dolphins.A

N = data_dolphins.N  # number of nodes

E = data_dolphins.E  # number of edges

Cn = data_dolphins.Cn    # cost of each vaccine

gamma = data_dolphins.gamma  # curing rate
...
def main():
    ...
    with open(pathes.dolphins_output, "w") as f:
