...
with open(pathes.household_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.household_data, edges)

np.savetxt(pathes.household_curingrate, gamma)

np.savetxt(pathes.household_cost, Cn)

with open(pathes.household_parameter, "w") as f:
