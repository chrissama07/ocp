...
import pathes
from networks.household import data_household

A = data_household.A

N = data_household.N  # number of nodes

E = data_household.E  # number of edges

Cn = data_household.Cn  # cost of each vaccine

gamma = data_household.gamma  # curing rate
...
def main():
    ...
    np.savetxt(pathes.household_initial, x_list[0].put_delta())
    ...
    # TODO
    with open(pathes.household_output, "w") as f:
    ...
    np.savetxt(pathes.household_current_to_rand_output, delta_list)
    np.savetxt(pathes.household_rand2_output, delta_list_rand2)
    np.savetxt(pathes.household_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.household_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.household_no_crossover_output, delta_list_no_crossover)
