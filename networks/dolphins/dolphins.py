...
with open(pathes.dolphins_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.dolphins_data, edges)

np.savetxt(pathes.dolphins_curingrate, gamma)

np.savetxt(pathes.dolphins_cost, Cn)

with open(pathes.dolphins_parameter, "w") as f:
