...
with open(pathes.infectious_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.infectious_data, edges)

np.savetxt(pathes.infectious_curingrate, gamma)

np.savetxt(pathes.infectious_cost, Cn)

with open(pathes.infectious_parameter, "w") as f:
