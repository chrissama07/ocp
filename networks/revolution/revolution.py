...
with open(pathes.revolution_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.revolution_data, edges)

np.savetxt(pathes.revolution_curingrate, gamma)

np.savetxt(pathes.revolution_cost, Cn)

with open(pathes.revolution_parameter, "w") as f:
