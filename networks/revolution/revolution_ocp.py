...
def main():
    ...
    # TODO
    with open(pathes.revolution_output, "w") as f:
    ...
    np.savetxt(pathes.revolution_current_to_rand_output, delta_list)
    np.savetxt(pathes.revolution_rand2_output, delta_list_rand2)
    np.savetxt(pathes.revolution_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.revolution_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.revolution_no_crossover_output, delta_list_no_crossover)
    np.savetxt(pathes.revolution_mms, delta_list_mms)
    np.savetxt(pathes.revolution_immsade, delta_list_immsade)
    np.savetxt(pathes.revolution_agde, delta_list_agde)
