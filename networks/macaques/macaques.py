...
with open(pathes.macaques_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.macaques_data, edges)

np.savetxt(pathes.macaques_curingrate, gamma)

np.savetxt(pathes.macaques_cost, Cn)

with open(pathes.macaques_parameter, "w") as f:
