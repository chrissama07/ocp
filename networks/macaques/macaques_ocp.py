...
def main():
    ...
    np.savetxt(pathes.macaques_initial, x_list[0].put_delta())
    ...
    # TODO
    with open(pathes.macaques_output, "w") as f:
    ...
    np.savetxt(pathes.macaques_current_to_rand_output, delta_list)
    np.savetxt(pathes.macaques_rand2_output, delta_list_rand2)
    np.savetxt(pathes.macaques_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.macaques_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.macaques_no_crossover_output, delta_list_no_crossover)
    np.savetxt(pathes.macaques_mms, delta_list_mms)
    np.savetxt(pathes.macaques_immsade, delta_list_immsade)
    np.savetxt(pathes.macaques_agde, delta_list_agde)
