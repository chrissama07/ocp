...
def main():
    ...
    np.savetxt(pathes.windsurfers_initial, x_list[0].put_delta())
    ...
    # TODO
    with open(pathes.windsurfers_output, "w") as f:
    ...
    np.savetxt(pathes.windsurfers_current_to_rand_output, delta_list)
    np.savetxt(pathes.windsurfers_rand2_output, delta_list_rand2)
    np.savetxt(pathes.windsurfers_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.windsurfers_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.windsurfers_no_crossover_output, delta_list_no_crossover)
    np.savetxt(pathes.windsurfers_mms, delta_list_mms)
    np.savetxt(pathes.windsurfers_immsade, delta_list_immsade)
    np.savetxt(pathes.windsurfers_agde, delta_list_agde)
