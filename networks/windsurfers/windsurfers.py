...
with open(pathes.windsurfers_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.windsurfers_data, edges)

np.savetxt(pathes.windsurfers_curingrate, gamma)

np.savetxt(pathes.windsurfers_cost, Cn)

with open(pathes.windsurfers_parameter, "w") as f:
