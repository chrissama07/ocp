...
def mms(xx_list, r1, r2, r3):
    ...
    #                  mms_F * np.subtract(xx_list[r1].delta, xx_list[2].delta))
    v_delta = np.maximum(v_delta, 0.36)
...
def main():
    ...
    np.savetxt(pathes.bundesliga_mms, delta_list_mms)
    np.savetxt(pathes.bundesliga_immsade, delta_list_immsade)
    np.savetxt(pathes.bundesliga_agde, delta_list_agde)
