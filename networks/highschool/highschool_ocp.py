...
def main():
    ...
    x_best_DE_rand_to_best = DE(x_list, 3)
    ...
    x_best_DE_current_to_best = DE(x_list, 4)
    ...
    x_best_DE_no_crossover = DE(x_list, 5)
    ...
    with open(pathes.highschool_output, "w") as f:
        text = f.write(str(blank_fit) + "\n" \
                       ...
                       + str(DESA_rand_to_best_time) + "\t" + str(DE_rand_to_best_fit) + "\t" + str(DESA_rand_to_best_fit) + "\n" \
                       + str(DESA_current_to_best_time) + "\t" + str(DE_current_to_best_fit) + "\t" + str(DESA_current_to_best_fit) + "\n" \
                       + str(DESA_no_crossover_time) + "\t" + str(DE_no_crossover_fit) + "\t" + str(DESA_no_crossover_fit))
    f.close()
