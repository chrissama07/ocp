...
def main():
    ...
    # TODO
    with open(pathes.highschool_output, "w") as f:
    ...
    np.savetxt(pathes.highschool_current_to_rand_output, delta_list)
    np.savetxt(pathes.highschool_rand2_output, delta_list_rand2)
    np.savetxt(pathes.highschool_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.highschool_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.highschool_no_crossover_output, delta_list_no_crossover)
    np.savetxt(pathes.highschool_mms, delta_list_mms)
    np.savetxt(pathes.highschool_immsade, delta_list_immsade)
    np.savetxt(pathes.highschool_agde, delta_list_agde)
