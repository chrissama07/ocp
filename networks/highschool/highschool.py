...
with open(pathes.highschool_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.highschool_data, edges)

np.savetxt(pathes.highschool_curingrate, gamma)

np.savetxt(pathes.highschool_cost, Cn)

with open(pathes.highschool_parameter, "w") as f:
