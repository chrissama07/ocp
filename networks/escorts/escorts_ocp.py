...
import pathes
from networks.escorts import data_escorts

A = data_escorts.A

N = data_escorts.N  # number of nodes

E = data_escorts.E  # number of edges

Cn = data_escorts.Cn  # cost of each vaccine

gamma = data_escorts.gamma  # curing rate
...
def main():
    ...
    np.savetxt(pathes.escorts_initial, x_list[0].put_delta())
    ...
    # TODO
    with open(pathes.escorts_output, "w") as f:
    ...
    np.savetxt(pathes.escorts_current_to_rand_output, delta_list)
    np.savetxt(pathes.escorts_rand2_output, delta_list_rand2)
    np.savetxt(pathes.escorts_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.escorts_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.escorts_no_crossover_output, delta_list_no_crossover)
    # np.savetxt(pathes.escorts_TS_output, delta_list_TS)
