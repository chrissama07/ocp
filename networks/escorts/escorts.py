...
with open(pathes.escorts_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.escorts_data, edges)

np.savetxt(pathes.escorts_curingrate, gamma)

np.savetxt(pathes.escorts_cost, Cn)

with open(pathes.escorts_parameter, "w") as f:
