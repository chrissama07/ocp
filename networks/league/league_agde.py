...
N = data_league.N  # number of nodes

E = data_league.E  # number of edges

Cn = data_league.Cn  # cost of each vaccine

gamma = data_league.gamma  # curing rate

Rou = data_league.Rou  # vaccination rate
...
def main():
    ...
    np.savetxt(pathes.league_agde_algorithm, delta_list_agde)
