...
with open(pathes.league_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.league_data, edges)

np.savetxt(pathes.league_curingrate, gamma)

np.savetxt(pathes.league_cost, Cn)

with open(pathes.league_parameter, "w") as f:
