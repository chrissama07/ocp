...
with open(pathes.bay_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.bay_data, edges)

np.savetxt(pathes.bay_curingrate, gamma)

np.savetxt(pathes.bay_cost, Cn)

with open(pathes.bay_parameter, "w") as f:
