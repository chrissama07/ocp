...
with open(pathes.NY_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.NY_data, edges)

np.savetxt(pathes.NY_curingrate, gamma)

np.savetxt(pathes.NY_cost, Cn)

with open(pathes.NY_parameter, "w") as f:
