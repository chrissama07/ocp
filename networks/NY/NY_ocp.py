...
import pathes
from networks.NY import data_NY

A = data_NY.A

N = data_NY.N  # number of nodes

E = data_NY.E  # number of edges

Cn = data_NY.Cn  # cost of each vaccine

gamma = data_NY.gamma  # curing rate
...
def main():
    ...
    np.savetxt(pathes.NY_initial, x_list[0].put_delta())
    ...
    # TODO
    with open(pathes.NY_output, "w") as f:
    ...
    np.savetxt(pathes.NY_current_to_rand_output, delta_list)
    np.savetxt(pathes.NY_rand2_output, delta_list_rand2)
    np.savetxt(pathes.NY_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.NY_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.NY_no_crossover_output, delta_list_no_crossover)
