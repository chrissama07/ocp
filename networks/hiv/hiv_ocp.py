...
def main():
    ...
    np.savetxt(pathes.hiv_initial, x_list[0].put_delta())
    ...
    # TODO
    with open(pathes.hiv_output, "w") as f:
    ...
    np.savetxt(pathes.hiv_current_to_rand_output, delta_list)
    np.savetxt(pathes.hiv_rand2_output, delta_list_rand2)
    np.savetxt(pathes.hiv_rand_to_best_output, delta_list_rand_to_best)
    np.savetxt(pathes.hiv_current_to_best_output, delta_list_current_to_best)
    np.savetxt(pathes.hiv_no_crossover_output, delta_list_no_crossover)
    np.savetxt(pathes.hiv_mms, delta_list_mms)
    np.savetxt(pathes.hiv_immsade, delta_list_immsade)
    np.savetxt(pathes.hiv_agde, delta_list_agde)
