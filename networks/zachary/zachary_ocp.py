...
def main():
    ...
    print(x_list[0].put_delta())
    np.savetxt(pathes.zachary_initial, x_list[0].put_delta())
    ...
    np.savetxt(pathes.zachary_mms, delta_list_mms)
    np.savetxt(pathes.zachary_immsade, delta_list_immsade)
    np.savetxt(pathes.zachary_agde, delta_list_agde)
