...
with open(pathes.zachary_source) as f:
    lines = f.readlines()
...
# save edges data
np.savetxt(pathes.zachary_data, edges)

np.savetxt(pathes.zachary_curingrate, gamma)

np.savetxt(pathes.zachary_cost, Cn)

with open(pathes.zachary_parameter, "w") as f:
