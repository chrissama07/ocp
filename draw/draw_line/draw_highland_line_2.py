...
y5 = np.loadtxt(pathes.highland_TS_output)
y6 = np.loadtxt(pathes.highland_SA_output)
y7 = np.loadtxt(draw_pathes.highland_mms_output)
y8 = np.loadtxt(draw_pathes.highland_immsade_output)
y9 = np.loadtxt(draw_pathes.highland_agde_output)
y10 = np.loadtxt(pathes.highland_agde_algorithm)
y11 = np.loadtxt(pathes.highland_GSK)
# for i in range(20):
...
plt.xlabel('Iteration', size=15)
plt.ylabel('Lowest Cost of Vaccination', size=15)
plt.savefig(draw_pathes.highland_pictures_linechart_2)
plt.show()
