...
# y_blank=np.loadtxt(draw_pathes.zachary_blank_output)
...
y5 = np.loadtxt(pathes.zachary_TS_output)
y6 = np.loadtxt(pathes.zachary_SA_output)
y7 = np.loadtxt(draw_pathes.zachary_mms_output)
y8 = np.loadtxt(draw_pathes.zachary_immsade_output)
y9 = np.loadtxt(draw_pathes.zachary_agde_output)
y10 = np.loadtxt(pathes.zachary_agde_algorithm)
y11 = np.loadtxt(pathes.zachary_GSK)
...
plt.xlabel('Iteration', size=15)
plt.ylabel('Lowest Cost of Vaccination', size=15)
plt.savefig(draw_pathes.zachary_pictures_linechart_2)
plt.show()
