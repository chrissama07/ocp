...
# y_blank=np.loadtxt(draw_pathes.highschool_blank_output)
# y0=np.linspace(y_blank,y_blank,21)
y = np.loadtxt(draw_pathes.highschool_rand_to_best_output) * 100
y1 = np.loadtxt(draw_pathes.highschool_rand2_output) * 100
y2 = np.loadtxt(draw_pathes.highschool_current_to_rand_output) * 100
y3 = np.loadtxt(draw_pathes.highschool_no_crossover_output) * 100
y4 = np.loadtxt(draw_pathes.highschool_current_to_best_output) * 100
y5 = np.loadtxt(pathes.highschool_TS_output) * 100
y6 = np.loadtxt(pathes.highschool_SA_output) * 100
y7 = np.loadtxt(draw_pathes.highschool_mms_output) * 100
y8 = np.loadtxt(draw_pathes.highschool_immsade_output) * 100
y9 = np.loadtxt(draw_pathes.highschool_agde_output) * 100
y10 = np.loadtxt(pathes.highschool_agde_algorithm) * 100
y11 = np.loadtxt(pathes.highschool_GSK) * 100
# for i in range(20):
...
plt.xlabel('Iteration', size=15)
plt.ylabel('Lowest Cost of Vaccination', size=15)
plt.savefig(draw_pathes.highschool_pictures_linechart_2)
plt.show()
