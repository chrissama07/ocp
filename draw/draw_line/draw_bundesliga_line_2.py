...
y5 = np.loadtxt(pathes.bundesliga_TS_output)
y6 = np.loadtxt(pathes.bundesliga_SA_output)
y7 = np.loadtxt(draw_pathes.bundesliga_mms_output)
y8 = np.loadtxt(draw_pathes.bundesliga_immsade_output)
y9 = np.loadtxt(draw_pathes.bundesliga_agde_output)
y10 = np.loadtxt(pathes.bundesliga_agde_algorithm)
y11 = np.loadtxt(pathes.bundesliga_GSK)
# for i in range(20):
