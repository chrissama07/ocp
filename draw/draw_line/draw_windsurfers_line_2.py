...
# y_blank=np.loadtxt(draw_pathes.windsurfers_blank_output)
# y0=np.linspace(y_blank,y_blank,21)
y = np.loadtxt(draw_pathes.windsurfers_rand_to_best_output)
y1 = np.loadtxt(draw_pathes.windsurfers_rand2_output)
y2 = np.loadtxt(draw_pathes.windsurfers_current_to_rand_output)
y3 = np.loadtxt(draw_pathes.windsurfers_no_crossover_output)
y4 = np.loadtxt(draw_pathes.windsurfers_current_to_best_output)
y5 = np.loadtxt(pathes.windsurfers_TS_output)
y6 = np.loadtxt(pathes.windsurfers_SA_output)
y7 = np.loadtxt(draw_pathes.windsurfers_mms_output)
y8 = np.loadtxt(draw_pathes.windsurfers_immsade_output)
y9 = np.loadtxt(draw_pathes.windsurfers_agde_output)
y10 = np.loadtxt(pathes.windsurfers_agde_algorithm)
y11 = np.loadtxt(pathes.windsurfers_GSK)
# for i in range(20):
...
plt.xlabel('Iteration', size=15)
plt.ylabel('Lowest Cost of Vaccination', size=15)
plt.savefig(draw_pathes.windsurfers_pictures_linechart_2)
plt.show()
