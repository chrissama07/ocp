...
y5 = np.loadtxt(pathes.macaques_TS_output) * 100
y6 = np.loadtxt(pathes.macaques_SA_output) * 100
y7 = np.loadtxt(draw_pathes.macaques_mms_output) * 100
y8 = np.loadtxt(draw_pathes.macaques_immsade_output) * 100
y9 = np.loadtxt(draw_pathes.macaques_agde_output) * 100
y10 = np.loadtxt(pathes.macaques_agde_algorithm) * 100
y11 = np.loadtxt(pathes.macaques_GSK) * 100
# for i in range(20):
