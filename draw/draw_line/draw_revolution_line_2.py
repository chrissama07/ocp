...
# y_blank=np.loadtxt(draw_pathes.revolution_blank_output)
...
y5 = np.loadtxt(pathes.revolution_TS_output)
y6 = np.loadtxt(pathes.revolution_SA_output)
y7 = np.loadtxt(draw_pathes.revolution_mms_output)
y8 = np.loadtxt(draw_pathes.revolution_immsade_output)
y9 = np.loadtxt(draw_pathes.revolution_agde_output)
y10 = np.loadtxt(pathes.revolution_agde_algorithm)
y11 = np.loadtxt(pathes.revolution_GSK)
...
plt.title('Infectious SocioPatterns', size=18)
...
#plt.figure(figsize=(8, 6))
plt.title('Infectious SocioPatterns Subgraph', size=18)
# plt.plot(x, y0, label='blank', linewidth=1, color='black')
...
plt.xlabel('Iteration', size=15)
plt.ylabel('Lowest Cost of Vaccination', size=15)
plt.savefig(draw_pathes.revolution_pictures_linechart_2)
plt.show()
