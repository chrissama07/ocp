...
y5 = np.loadtxt(draw_pathes.highschool_mms_output) * 100
y6 = np.loadtxt(draw_pathes.highschool_immsade_output) * 100
y7 = np.loadtxt(draw_pathes.highschool_agde_output) * 100
...
plt.xticks([i for i in range(0, 50, 5)])
ax2.set_ylim(470 * 100, 490 * 100)
ax3.set_ylim(390 * 100, 411 * 100)
