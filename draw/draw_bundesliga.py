...
y5 = np.loadtxt(draw_pathes.bundesliga_mms_output)
y6 = np.loadtxt(draw_pathes.bundesliga_immsade_output)
y7 = np.loadtxt(draw_pathes.bundesliga_agde_output)
...
plt.legend(loc='upper right')  # 给label用的
...
plt.xticks([i for i in range(0, 50, 5)])
ax2.set_ylim(2190, 2300)
ax3.set_ylim(1950, 2080)
