...
y5 = np.loadtxt(draw_pathes.windsurfers_mms_output)
y6 = np.loadtxt(draw_pathes.windsurfers_immsade_output)
y7 = np.loadtxt(draw_pathes.windsurfers_agde_output)
...
plt.xticks([i for i in range(0, 50, 5)])
ax2.set_ylim(281.7, 282.05)
ax3.set_ylim(249, 261)
