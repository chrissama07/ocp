...
y5 = np.loadtxt(draw_pathes.hiv_mms_output)
y6 = np.loadtxt(draw_pathes.hiv_immsade_output)
y7 = np.loadtxt(draw_pathes.hiv_agde_output)
...
# TODO:
ax2.set_ylim(262, 262.6)
ax3.set_ylim(224, 260)
...
plt.savefig(draw_pathes.hiv_pictures_linechart_1)
plt.show()
